    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">
          Acompanhe todos os pagamentos realizados no sistema
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-sm text-gray-500 mt-1">Todas as transações</p>
        </div>
      </div>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {data.payments.map((payment) => (
                    <tr key={payment.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${getPlanBadgeColor(payment.plan)}`}>
