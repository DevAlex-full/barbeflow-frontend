        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl md:text-3xl font-bold text-gray-900 mt-1 md:mt-2">{stats?.totalCustomers}</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl md:text-3xl font-bold text-gray-900 mt-1 md:mt-2">{stats?.totalServices}</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl md:text-3xl font-bold text-gray-900 mt-1 md:mt-2">{stats?.todayAppointments}</p>
            </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <div className="p-4 md:p-6">
          {stats?.upcomingAppointments && stats.upcomingAppointments.length > 0 ? (
            ...
            <p className="text-center text-gray-500 py-8 text-sm md:text-base">Nenhum agendamento próximo</p>
          )}
        </div>
      </div>
    </div>
