...
export default function RedefinirSenhaForm() {
    ...
    const validateToken = async () => {
      ...
      try {
        const response = await fetch(
          `https://barberflow-back-end-19nv.onrender.com/api/client/auth/validate-reset-token?token=${token}`
        );
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch('https://barberflow-back-end-19nv.onrender.com/api/client/auth/reset-password', {
        method: 'POST',
